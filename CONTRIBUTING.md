...
Open an issue for the change you want to make, or pick up an existing issue. `docs/ROADMAP.md`
lists planned work, and `docs/` is the reference for how the system is designed.
...
4. If a change completes a roadmap entry, remove that entry from `docs/ROADMAP.md` in the same PR.
